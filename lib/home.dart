                        ...
                        children: <Widget>[
                          ...
                          for (Map<String, dynamic> algorithms in salts[index]!["algorithms"]) ...<Widget>[
                            ...
                            if (salts[index]!["title"] == algorithms["types"].keys[0])
                              ...
                              for (MapEntry type in algorithms["types"]) ...<Widget>[Text(" ${algorithms["algorithm"]}", style: TextStyle(fontSize: 16, fontWeight: FontWeight.w500, color: mainColor.withOpacity(.4))), const SizedBox(height: 10), Flexible(child: Text(salts[index]![2], style: TextStyle(fontSize: 14, fontWeight: FontWeight.w500, color: mainColor.withOpacity(.6))))],
                          ],
                        ],
                      ),
                    );
