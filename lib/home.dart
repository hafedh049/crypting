                    ...
                    return Container(
                      ...
                      child: Column(
                        children: <Widget>[
                          ...
                          for (Map<String, dynamic> algorithms in salts[index]!["algorithms"]) ...<Widget>[Text(" ${algorithms["algorithm"]}", style: TextStyle(fontSize: 14, fontWeight: FontWeight.w500, color: mainColor.withOpacity(.6))), const SizedBox(height: 10), if (1 == 1) Container() else Container()],
